      ...
      >
        ...
        >
          ...
          <Card.Content className="py-3 px-3 " pointer>
            <h3 className="text-[16px] text-lightSecondary font-semibold">
              Descubre más sobre tu notebook:
            </h3>
        ...
        >
          ...
          <Card.Content className="py-3 px-3" pointer>
            ...
            <p className="text-[12px] text-lightPrimary opacity-30 mt-4">
              Aprovecha al máximo tu notebook, adquiere nuevas habilidades 
              y expande tus conocimientos.
            </p>
          </Card.Content>
        </Card.Root>
        <Card.Root
        ...
        >
          ...
          <Card.Content className="py-3 px-3" pointer>
            ...
            <p className="text-[12px] text-lightPrimary opacity-30 mt-4">
              Nuestro equipo de asistencia técnica está listo para ayudarte
              y poder seguir utilizando tu notebook como el primer día.
            </p>
          </Card.Content>
        </Card.Root>
      </Card.Container>
