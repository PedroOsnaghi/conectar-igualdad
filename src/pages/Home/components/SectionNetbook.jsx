    ...
    <section className="container mt-28 mx-auto flex flex-col items-center relative mb-0 md:mb-[-200px]">
      ...
      <div className="flex mt-9">
        ...
        <div className="mt-4 md:mt-[120px] mx-8">
          ...
          <a
            className={`transition-opacity duration-[2000ms] ease-in-out delay-[1.5s]  flex items-center gap-4 text-lg text-lightPrimary bg-secondary bg-opacity-75 max-w-max mx-auto mt-4  md:mt-16 py-1 px-8 border-[.5px] border-primary rounded-[5px] hover:bg-opacity-100 cursor-pointer ${
