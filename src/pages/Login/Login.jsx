    ...
    <>
      ...
      <main className="h-full w-full">
        <div className="container mx-auto px-8 md:px-[100px] h-full w-full mb-[64px]">
          <FormContainer className="mt-12 md:mx-40 z-30 ">
            ...
            <div className="flex flex-col md:flex-row gap-3 ">
              <article className="flex md:flex-col md:w-[40%]  text-white bg-primary rounded-md overflow-hidden px-4 py-7">
                <img
                  src={logoME}
                  alt="Logo Ministerio de Educacion"
                  className="w-[70%] md:w-[90%] mx-auto"
                />
              </article>
              <article className=" md:px-4 flex flex-col w-full h-[450px] md:h-[550px]">
                <form method="post">
                  ...
                  <div className="flex flex-col md:flex-row text-center md:text-left justify-between">
                    ...
                    <span className="mt-4 md:mt-0 text-white">
